...
It provides guidance to improve web application security.

The OWASP Top 10 is a list of the most common and serious web application security risks.  
This list is updated regularly based on real-world security data.
...
- Web security basics are very important  
